            ...
            <tbody>
                @forelse($products as $product)
                    <tr id="product-{{ $product->id }}">
                        ...
                        <td>
                            @if ($product->img_path)
                                <img src="{{ asset($product->img_path) }}" style="width:50px; height:50px; border-radius:8px;"
                                    alt="Product Image">
                            @else
                        ...
                        <td>
                            <a href="javascript:void(0)" class="btn btn-info btn-sm showProductBtn"
                                data-id="{{ $product->id }}">View</a>
                            <a href="javascript:void(0)" class="btn btn-warning btn-sm editProductBtn"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        var imageHtml = product.img_path ?
                            ...
                            '" style="width:50px; height:50px; border-radius:8px;" alt="Product Image">' :
                            '<span class="text-muted">No Image</span>';
                        ...
                        var newRow = '<tr id="product-' + product.id + '">' +
                            ...
                            '<td>' + imageHtml + '</td>' +
                            '<td>' +
                            '<a href="javascript:void(0)" class="btn btn-info btn-sm showProductBtn" data-id="' +
                            product.id + '">View</a> ' +
                            '<a href="javascript:void(0)" class="btn btn-warning btn-sm editProductBtn" data-id="' +
                            product.id + '">Edit</a> ' +
